...
<div class="row">
    <div class="col-md-6 col-md-offset-3">
        ...
        <p>
            ...
            <img src="https://localhost/wordpress/wp-content/uploads/2021/06/sellos.jpg" alt="Sello de ejemplo" width="120" height="120">
        </p>
        <form role="form" action="<?php the_permalink(); ?>" id="contactForm" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="stampFile">Incluir imagen:</label>
                <input type="file" id="stampFile" name="stampFile" class="form-control">
            ...
            <div class="form-group">
                <p>Elige el color de la tintaaaaa:</p>
    ...
    <div id="error_message" style="width:100%; height:100%; display:none; ">
        <h3>Error: </h3>
        <p>Se produjo un error al enviar el formulario. Si lo prefiere mándenos un email directamente: info@ofiteldigital.com</p>
    </div>
</div>
